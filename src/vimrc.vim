...
" 5 key binds to effectively use this plugin
...
" my mappings because they are easier to memorize.
...
" syntax and file types. It does not slow down vim at all as you may suspect.
Plug 'sheerun/vim-polyglot'
" Highlights yanked text. Extremely useful for knowing what you copied and if
" you did so.
...
" default. For instance, do ':e .' and you'll get the same thing as Nerdtree.
...
set hlsearch
set incsearch
" Set Paste mode keybind, Paste mode is for for using vim in a terminal and
...
set termguicolors
colorscheme zephyr
" this airline theme adapts to your colorscheme
...
let g:vimwiki_list = [{'path': '~/vimwiki',
          ...
          \ 'template_ext': '.html'}]
" Make vimwiki look clean by having no extraneous information like numberline
" or folds
...
" Toggle insert/replace with function key 9
